  ...
  return (
    <div className="overflow-x-hidden bg-gray-50 dark:bg-zinc-950 border-b border-gray-200 dark:border-gray-800">
      <header className="relative container mx-auto flex flex-col overflow-hidden px-4 py-4 text-blue-900 md:mx-auto md:flex-row md:items-center dark:text-slate-100">
        <Link href="/" className="flex cursor-pointer items-center whitespace-nowrap text-2xl font-black text-primary">
        ...
        <nav aria-label="Header Navigation" className=" peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full sm:peer-checked:mt-8 md:mt-0 md:flex-row md:items-start">
          <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
            <li className="font-bold md:mr-12"><Link href="#">Servicios</Link></li>
            <li className="md:mr-12"><Link href="#">Contacto</Link></li>
